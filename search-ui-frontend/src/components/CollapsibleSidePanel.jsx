...
type CollapsibleSidePanelDefaultProps = {
  bordered: boolean;
  collapsed: boolean;
}

type CollapsibleSidePanelState = {
  open: boolean;
}
 ...
 */
export default class CollapsibleSidePanel extends React.Component<CollapsiblePanelDefaultProps, CollapsiblePanelProps, CollapsiblePanelState> { // eslint-disable-line max-len
  static defaultProps = {
    bordered: false,
    collapsed: false,
  };

  constructor(props: CollapsibleSidePanelProps) {
    super(props);
    this.state = {
  ...
  state: CollapsibleSidePanelState;
  props: CollapsibleSidePanelProps;
